...
class Processing(object):
    ...
    def process(self, CB):
        ...
        trigger_command = """(cd {heimdall_dir}; mkdir plots; mkdir data;
            ...
            gs -dBATCH -dNOPAUSE -q -sDEVICE=pdfwrite -dPDFSETTINGS=/prepress -sOutputFile={result_dir}/CB{CB:02d}.pdf {heimdall_dir}/plots/*pdf) 2>&1 > {result_dir}/CB{CB:02d}_trigger.log""".format(CB=CB, **localconfig)
