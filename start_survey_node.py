        ...
        if self.config['amber_mode'] == 'bruteforce':
            ...
            for ind in range(len(ambercfg['opencl_device'])):
                ...
                cmd = (" taskset -c {cpu} amber -sync -print -opencl_platform {opencl_platform}"
                       ...
                       " -synthesized_beams_file /home/arts/ARTS-obs/sbtable-12tabs-71sbs.txt"
                       " -synthesized_beams_chunk {sb_per_chunk}"
                       ...
                       " -snr_sc -nsigma {snr_sigma_clip} "
                       " -snr_file {amber_conf_dir}/snr.conf -max_std_file {amber_conf_dir}/max_std.conf"
