...
class Survey(object):
    ...
    def heimdall(self):
        ...
        os.system("mkdir -p {}".format(output_dir))
        cmd = "taskset -c {cpu} heimdall -beam {beam} -k {dadakey} -dm 0 {heimdall_dm_max} -gpu_id 0 -output_dir {output_heimdall}".format(cpu=cpu, output_heimdall=output_dir, **self.config)
        self.log(cmd)
        os.system(cmd)
